...
# <xbar.title>Terminal Notifications</xbar.title>
# <xbar.version>v3.0.0</xbar.version>
# <xbar.author>Timothy</xbar.author>
# <xbar.desc>Enable or disable cross-Space native notifications.</xbar.desc>
...
echo "---"
echo "通知顯示於目前螢幕右下角 | color=gray size=11"
echo "浮窗約 5 秒後自動關閉 | color=gray size=11"
